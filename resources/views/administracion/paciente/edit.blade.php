    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form method="POST" action="{{ route('paciente.update', $paciente->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row gy-4">
                                ...
                                <div class="card-body border-bottom border-block-end-dashed">
                                    <div class="text-center">
                                        <span class="avatar avatar-xxl avatar-rounded online mb-3" style="cursor: pointer;">
                                            <img id="previewImage"
                                                src="{{ $paciente->foto ? asset('imagenes/' . $paciente->foto) : asset('assets/images/faces/11.jpg') }}"
                                                alt="Foto de perfil">
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <select class="form-select" name="sexo" required>
                                    ...
                                    <option value="1" {{ old('sexo', $paciente->sexo) == 1 ? 'selected' : '' }}>
                                        Masculino</option>
                                    <option value="2" {{ old('sexo', $paciente->sexo) == 2 ? 'selected' : '' }}>
                                        Femenino</option>
                                </select>
                            </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <textarea class="form-control" name="observaciones" rows="5">{{ old('observaciones', $paciente->observaciones) }}</textarea>
                            </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <select class="form-control select2" name="pais_id">
                                ...
                                <select class="form-select" name="departamento_id" onchange="getDistritos(this.value)">
                                    ...
                                    @foreach ($departamentos as $departamento)
                                        <option value="{{ $departamento->id }}"
                                            {{ old('departamento_id', $paciente->distrito->municipio->departamento_id ?? '') == $departamento->id ? 'selected' : '' }}>
                                            {{ $departamento->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="distrito_id" id="distrito_id">
                                    ...
                                    @foreach ($distritos as $distrito)
                                        <option value="{{ $distrito->id }}"
                                            {{ old('distrito_id', $paciente->distrito_id) == $distrito->id ? 'selected' : '' }}>
                                            {{ $distrito->nombre }}
                                        </option>
                                    @endforeach
                                </select>
