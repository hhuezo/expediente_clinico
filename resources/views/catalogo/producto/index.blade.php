...
@section('content')
                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($productos as $item)
                                    <tr>
                                        ...
                                        <td><label class="switch">
                                                <input type="checkbox" {{ $item->activo == 1 ? 'checked' : '' }}
                                                    onChange="toggleproductoActivo({{ $item->id }})">
                                    ...
                                    @include('catalogo.producto.edit')
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Crear medicamento</h6>
    ...
    <script>
        $(document).ready(function() {
            expandMenuAndHighlightOption('catalogoMenu', 'productoOption');
        ...
        function toggleproductoActivo(id) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.success) {
                        toastr.success('Estado del producto actualizado');
                    } else {
